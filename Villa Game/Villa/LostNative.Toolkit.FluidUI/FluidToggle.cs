...
public class FluidToggle : MonoBehaviour
{
	...
	protected virtual void StartToggleSequence(float targetXPosition)
	{
		...
		TweenerCore<Vector2, Vector2, VectorOptions> t = toggleRectTransform.DOAnchorPosX(targetXPosition, movementTime);
		TweenerCore<Vector2, Vector2, VectorOptions> t2 = toggleRectTransform.DOSizeDelta(new Vector2(stretchedSize, toggleRectTransform.sizeDelta.y), stretchTime);
		TweenerCore<Vector2, Vector2, VectorOptions> t3 = toggleRectTransform.DOSizeDelta(new Vector2(compressedSize, toggleRectTransform.sizeDelta.y), compressedTime);
