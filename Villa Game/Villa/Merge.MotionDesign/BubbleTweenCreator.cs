...
public class BubbleTweenCreator : MonoBehaviour
{
	...
	public BubbleEffect CreateBubbleEffect(GameItem gi)
	{
		...
		sequence.Join(bubbleEffect.Bubble.DOFade(idleInfo.bubbleAlpha, idleInfo.time));
		...
		sequence.Join(gi.IconRenderer.DOFade(idleInfo.itemAlpha, idleInfo.time));
	...
	public Tween PopFromBubble(GameItem poped, GIGhost bubbled, BubbleEffect effect)
	{
		...
		sequence.Join(effect.Bubble.DOFade(0f, popItemInfo.destroyGhostTime));
	...
	public Tween UnlockBubble(GameItem gi, BubbleEffect effect)
	{
		...
		sequence2.Join(effect.Bubble.DOFade(0f, popItemInfo.destroyGhostTime));
		...
		sequence.Join(gi.IconRenderer.DOFade(1f, popItemInfo.destroyGhostTime));
