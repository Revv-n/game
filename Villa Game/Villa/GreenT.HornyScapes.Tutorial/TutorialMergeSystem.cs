...
public class TutorialMergeSystem : TutorialEntitySystem<TutorialEntityComponent, TutorialEntityStepSO>
{
	public List<TutorialEntityStepSO> Steps = new List<TutorialEntityStepSO>();

	private bool subsystemInited;

	private TutorialMergeFinderSubSystem finderSystem;
	...
	{
		finderSystem = new TutorialMergeFinderSubSystem();
