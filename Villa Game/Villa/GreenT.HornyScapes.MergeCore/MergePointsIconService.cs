...
public class MergePointsIconService
{
	...
	{
		return _battlePassProvider.CalendarChangeProperty.Value.battlePass?.CurrentViewSettings.Currency;
	}

	private Sprite GetEventIcon()
	{
		return _eventProvider.CurrentCalendarProperty.Value.@event?.ViewSettings.Currency;
	}
}
