...
public sealed class TrackableCurrencyActionContainer : ICurrenciesActionContainer, IDisposable, ITrackableCurrencyContainer
{
	...
	public IReadOnlyReactiveProperty<int> ReactiveCount => _mainBalance[_currencyType, _compositeIdentificator].Count;
	...
	{
		return _spendStream.AsObservable();
	}

	public IObservable<int> OnAdd()
	{
		return _addStream.AsObservable();
	}
