...
public class SubscriptionPushNotifierFactory : IFactory<SubscriptionPushSettings, SubscriptionTimePushNotifier>, IFactory, IFactory<SubscriptionModel, SubscriptionDailyPushNotifier>
{
	...
	{
		SubscriptionTimePushNotifier subscriptionTimePushNotifier = _container.Instantiate<SubscriptionTimePushNotifier>(new object[1] { settings });
	...
	{
		SubscriptionDailyPushNotifier subscriptionDailyPushNotifier = _container.Instantiate<SubscriptionDailyPushNotifier>(new object[1] { model });
