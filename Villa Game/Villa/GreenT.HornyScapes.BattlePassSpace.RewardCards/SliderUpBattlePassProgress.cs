...
public class SliderUpBattlePassProgress : MonoView<BattlePass>
{
	...
	public override void Set(BattlePass newBattlePass)
	{
		...
		_pointStream = base.Source.Data.LevelInfo.Points.Subscribe(OnProgressPointsChanged);
	...
	{
		TMP_Text text = _levelViewObject.Text;
		int targetLevel = _currentPairData.TargetLevel;
