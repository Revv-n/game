...
public class ResponseOptionView : Button, IView<ResponseOption>, IView
{
	...
	public IObservable<ResponseOption> OnSet => onSet.AsObservable();
	...
	public void Set(ResponseOption option)
	{
		...
		_optionDisposable = _localizationService.ObservableText(option.LocalizationKey).Subscribe(delegate(string text)
		{
