...
public class RequestFactory
{
	...
	public GreenT.AssetBundles.Communication.AssetBundleRequest CreateRequest(string path, string nameBundle, BuildMainInfo buildMainInfo, AssetBundle previewAssetBundle = null)
	{
