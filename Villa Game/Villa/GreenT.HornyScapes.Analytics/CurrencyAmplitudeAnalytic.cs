...
public class CurrencyAmplitudeAnalytic
{
	...
	public IObservable<EnergyRecievedAnalyticData> OnEnergyRecieved => onEnergyRecieved;

	public IObservable<EnergySpendAnalyticData> OnEnergySpend => onEnergySpend;
