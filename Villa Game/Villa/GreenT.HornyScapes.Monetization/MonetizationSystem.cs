...
public abstract class MonetizationSystem<TData> : IIAPController<TData>, IInitializable, IDisposable where TData : new()
{
	...
	public virtual IObservable<Product> OnPressButton => onPressButton.AsObservable();

	public virtual IObservable<CheckoutData> OnOpenForm => onOpenForm.AsObservable();

	public virtual IObservable<TData> OnSucceeded => onSucceeded.AsObservable();

	public virtual IObservable<string> OnFailed => onFailed.AsObservable();

	public virtual void Initialize()
	{
		OnFailed.Subscribe(delegate
		{
		}).AddTo(logStream);
	}
