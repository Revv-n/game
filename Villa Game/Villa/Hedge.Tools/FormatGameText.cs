...
public static class FormatGameText
{
	...
	public static IReadOnlyReactiveProperty<NumberFormat> NumberFormatStream => numberFormat.ToReadOnlyReactiveProperty();
	...
	{
		return NumberFormatStream.Select((NumberFormat x) => value.ToShortNumber());
	}
