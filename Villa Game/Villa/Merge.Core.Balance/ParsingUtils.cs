...
public static class ParsingUtils
{
	public static class MergePointsParser
	{
		...
		{
			string[] currencyTypeArray = currencyTypeStrings.Split(',');
			string[] unlockTypeArrays = unlockTypeStrings.Split('|');
			string[] unlockValueArrays = unlockValueStrings.Split('|');
			string[] chanceArray = chanceStrings.Split(',');
			string[] quantityArray = quantityStrings.Split(',');
		...
		{
			string[] array = unlockTypeString.Split(',');
			string[] array2 = unlockValueString.Split(',');
	...
	public static int[] ParseIntWeightArray(string expression)
	{
		...
		list.AddRange(expression.Split(";").Select(int.Parse));
		return list.ToArray();
	}
	...
	public static GIData ParseGIData(string expression)
	{
		...
		string[] array = expression.Substring(num + 1, length).Split('|');
