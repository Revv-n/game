...
public class BackgroundView : MonoView<DatePhrase>
{
	...
	private void ChangeBackgrounds()
	{
		...
		for (int i = 0; i < base.Source.BackgroundDatas.Length; i++)
		{
			...
			AnimationDateView animationDateView = Object.Instantiate(dateBackgroundData.AnimatedBackground, _animatedBackgroundContainer);
	...
	{
		string[] array = base.Source.BackgroundIds[index].Split(':');
		string key = array[0];
