...
public class BattlePassStartData : ISavableState, IDisposable
{
	...
	private readonly ReactiveProperty<bool> _firstStartedProgress = new ReactiveProperty<bool>(initialValue: true);
	...
	public IReadOnlyReactiveProperty<bool> WasFirstTimeStarted => _wasFirstTimeStarted;

	public IReadOnlyReactiveProperty<bool> WasFirstTimePushed => _wasFirstTimePushed;

	public IReadOnlyReactiveProperty<bool> FirstStartedProgress => _firstStartedProgress;

	public IReadOnlyReactiveProperty<bool> PremiumPurchasedProperty => _premiumPurchasedProperty;
	...
	public void Initialize(ReactiveProperty<bool> premiumPurchasedProperty)
	{
		...
		{
			_premiumUpdateStream = _premiumPurchasedProperty.Subscribe(delegate(bool value)
			{
