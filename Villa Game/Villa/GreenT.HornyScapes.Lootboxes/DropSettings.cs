...
public class DropSettings : IDrop
{
	...
	{
		LinkedContentAnalyticData param = analyticDataFactory.Create(sourceType);
		return linkedContentFactory.Create(Type, Selector, Quantity, Delta, ContentType, param);
	}
}
