...
public class StoreSection : IDisposable, ISavableState
{
	...
	public IObservable<StoreSection> OnClear => _onClear;

	public IObservable<SectionRefreshRequest> OnRequestRefresh => _onRequestRefresh.AsObservable();

	public IObservable<StoreSection> OntRefresh => _onRefresh.AsObservable();
	...
	private void StartTimer(TimeSpan timeSpan)
	{
		...
		_timeStream = _refreshTimer.OnTimeIsUp.Subscribe(delegate
		{
			FreeRequestRefresh();
