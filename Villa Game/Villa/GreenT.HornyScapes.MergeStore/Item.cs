...
public class Item : IItem
{
	...
	public IReactiveProperty<bool> Purchased => _purchased;

	public IObservable<IItem> OnClear => _onClear;

	public IObservable<ItemBuyRequest> PurchasedRequest => _purchasedRequest;
