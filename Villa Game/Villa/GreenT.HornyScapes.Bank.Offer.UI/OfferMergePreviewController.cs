...
public class OfferMergePreviewController : OfferPreviewControllerBase
{
	...
	private ReactiveProperty<OfferSettings> offerInFocus = new ReactiveProperty<OfferSettings>(null);

	public IReadOnlyReactiveProperty<OfferSettings> OfferInFocus => offerInFocus.ToReadOnlyReactiveProperty();
	...
	public void SwipeTimer(bool isOn)
	{
		...
		{
			observableSwipe = Observable.Timer(swipeTime, Scheduler.MainThreadIgnoreTimeScale).Subscribe(delegate
			{
