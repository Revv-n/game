...
public sealed class Conversation : IDisposable
{
	...
	public IObservable<Conversation> OnUpdate => _onUpdate;

	public IObservable<Conversation> OnHaveNewUpdate => _onHaveNewUpdate;
	...
	public void AddRange(IEnumerable<Dialogue> dialogues)
	{
		foreach (Dialogue dialogue in dialogues)
		{
			...
			dialogue.OnUpdate.Subscribe(OnUpdateDialogue).AddTo(_dialoguesUpdateStream);
		}
