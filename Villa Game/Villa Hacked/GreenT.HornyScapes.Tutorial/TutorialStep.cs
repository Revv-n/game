...
public class TutorialStep : ISavableState, ITutorialModel
{
	...
	public ReactiveProperty<bool> IsComplete { get; } = new ReactiveProperty<bool>(false);


	public ReactiveProperty<bool> IsInProgressStep { get; } = new ReactiveProperty<bool>(false);


	public IObservable<TutorialStep> OnUpdate => Observable.AsObservable<TutorialStep>((IObservable<TutorialStep>)onUpdate);
