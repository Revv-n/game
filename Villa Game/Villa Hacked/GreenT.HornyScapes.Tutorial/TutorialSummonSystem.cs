...
public class TutorialSummonSystem : TutorialComponentSystem<TutorialComponent, TutorialStepSO>
{
	...
	public override bool TryInitSystem()
	{
		...
		disposable = ObservableExtensions.Subscribe<SummonLot>(Observable.Where<SummonLot>((IObservable<SummonLot>)summonView.OnSet, (Func<SummonLot, bool>)((SummonLot _lot) => _lot != null)), (Action<SummonLot>)delegate
		{
			SubscribeInteract();
		});
		return true;
