...
public class TutorialTaskSystem : TutorialComponentSystem<TutorialEntityComponent, TutorialEntityStepSO>
{
	[SerializeField]
	...
	protected virtual void OnValidate()
	{
		if (taskView == null)
		{
			taskView = UnityEngine.Object.FindObjectOfType<TaskView>();
		}
	}
	...
	public override bool TryInitSystem()
	{
		...
		disposable = ObservableExtensions.Subscribe<Task>(taskView.OnSet, (Action<Task>)delegate
		{
			SubscribeInteract();
		});
		return true;
