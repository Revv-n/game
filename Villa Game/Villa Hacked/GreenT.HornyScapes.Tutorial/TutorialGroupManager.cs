...
public class TutorialGroupManager : SimpleManager<TutorialGroupSteps>
{
	...
	{
		return Observable.Merge<TutorialGroupSteps>(Observable.ToObservable<TutorialGroupSteps>(Collection.Where((TutorialGroupSteps _group) => !_group.IsCompleted.Value)), new IObservable<TutorialGroupSteps>[1] { OnNew });
	}
