...
public class TutorialSpawnerReloadSubSystem : IDisposable
{
	...
	public void SubscribeOnActivate(TutorialComponent component)
	{
		...
		onActivateStream.Add(ObservableExtensions.Subscribe<BaseTutorialComponent<TutorialStepSO>>(component.OnActivate, (Action<BaseTutorialComponent<TutorialStepSO>>)delegate
		{
