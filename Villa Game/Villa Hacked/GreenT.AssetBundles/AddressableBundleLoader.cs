...
public class AddressableBundleLoader
{
	...
	{
		return Observable.FromCoroutine<IAssetBundle>((Func<IObserver<IAssetBundle>, CancellationToken, IEnumerator>)((IObserver<IAssetBundle> observer, CancellationToken cancellationToken) => LoadBundleCoroutine(locations, bundleName, observer, cancellationToken)));
	}
