...
public class PresentView : MonoView<Present>
{
	...
	public IObservable<PresentView> OnSet => Observable.AsObservable<PresentView>((IObservable<PresentView>)_onSet);
	...
	public override void Set(Present source)
	{
		...
		_countSubscription = ObservableExtensions.Subscribe<int>((IObservable<int>)base.Source.Container.ReactiveCount, (Action<int>)UpdatePresentsCount);
		_onSet?.OnNext(this);
	}
