...
public sealed class StarResetUponProgress : ISavableState, IDisposable
{
	...
	{
		saver.Add(this);
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<bool>(Observable.Where<bool>((IObservable<bool>)lockerConstant["star_reset_upon_progress"].IsOpen, (Func<bool, bool>)((bool x) => x)), (Action<bool>)Check), (ICollection<IDisposable>)disposable);
	}
