...
public class ErolabsSDK
{
	...
	public static IEnumerator Initialize(Action<bool> callback = null, Games.Coresdk.Unity.Language lang = Games.Coresdk.Unity.Language.en, Platform platform = Platform.R18)
	{
		ConfigLoader.JSON_FILENAME = "erolabs_domain_v1";
		return Coresdk.Initialize(lang, platform, callback);
	}

	public static void SetLanguage(Games.Coresdk.Unity.Language lang)
	{
