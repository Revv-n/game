...
public class Relationship : ISavableState
{
	...
	private readonly ReactiveProperty<bool> _wasComingSoonDates = new ReactiveProperty<bool>(false);
	...
	public IReadOnlyReactiveProperty<bool> WasComingSoonDates => (IReadOnlyReactiveProperty<bool>)(object)_wasComingSoonDates;
