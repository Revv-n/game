...
public class ViewParameters<T> where T : ViewParameters
{
	...
	public Animation BeforeChangeAnimation => beforeChangeAnimation;

	public Animation AfterChangeAnimation => afterChangeAnimation;
	...
	public ViewParameters(Vector2 position, Vector2 localScale, int order, Vector2[] points, List<T> skinInfos, Animation beforeChangeAnimation, Animation afterChangeAnimation, Material material, Material blendMaterial, bool disableCollision)
	{
