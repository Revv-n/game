...
public class RoomObjectEditorHelper : MonoBehaviour
{
	...
	[SerializeField]
	private List<Animation> beforeChangeAnimations = new List<Animation>();

	[SerializeField]
	private List<Animation> afterChangeAnimations = new List<Animation>();
	...
	public void CreateAnimations(RoomObjectEditorView view)
	{
		...
		{
			Animation animation = Object.Instantiate(view.AfterChangeAnimation, view.transform);
		...
		{
			Animation animation2 = Object.Instantiate(view.BeforeChangeAnimation, view.transform);
