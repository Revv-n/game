...
public class PictureSwitcher : MonoBehaviour
{
	...
	{
		ObservableExtensions.Subscribe<CharacterSettings>(Observable.TakeUntilDisable<CharacterSettings>(Observable.SelectMany<CardPictures, CharacterSettings>(Observable.Where<CardPictures>((IObservable<CardPictures>)pictureSelector.Current, (Func<CardPictures, bool>)((CardPictures _pic) => _pic != null)), (Func<CardPictures, IObservable<CharacterSettings>>)((CardPictures _pic) => Observable.StartWith<CharacterSettings>(_pic.CharacterSettings.OnUpdate, _pic.CharacterSettings))), (Component)this), (Action<CharacterSettings>)InitToggles);
	}
	...
	private void SetLevelUpStream(CharacterSettings characterSettings)
	{
		...
		levelUpStream = ObservableExtensions.Subscribe<int>(Observable.TakeUntilDisable<int>(Observable.Where<int>(Observable.Skip<int>((IObservable<int>)characterSettings.Promote.Level, 1), (Func<int, bool>)IsUpToNeedLevel), (Component)this), (Action<int>)OnLevelUp);
