...
public class StarShopManager : SimpleManager<StarShopItem>
{
	...
	{
		OnUpdate = Observable.SelectMany<StarShopItem, StarShopItem>(Observable.Merge<StarShopItem>(Observable.ToObservable<StarShopItem>(Collection), new IObservable<StarShopItem>[1] { (IObservable<StarShopItem>)onNew }), (Func<StarShopItem, IObservable<StarShopItem>>)((StarShopItem _item) => _item.OnUpdate));
	}
