...
public class HouseCheat : IInitializable, IDisposable
{
	...
	{
		_disposable = ObservableExtensions.Subscribe<IRoomObject<BaseObjectConfig>>(_roomObjectsBuilder.OnCreated, (Action<IRoomObject<BaseObjectConfig>>)delegate(IRoomObject<BaseObjectConfig> _roomObject)
		{
