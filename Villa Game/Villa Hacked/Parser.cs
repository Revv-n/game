...
public class Parser : MonoBehaviour
{
	...
	{
		string[] array = firstCell.Split('|', StringSplitOptions.None);
		string block = array[0].Split(':', StringSplitOptions.None)[1];
		string version = array[1].Split(':', StringSplitOptions.None)[1];
