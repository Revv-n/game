...
public class BattlePass : IBundleProvider<BattlePassBundleData>, IRewardHolder, IDisposable
{
	...
	public IObservable<RewardWithManyConditions> OnRewardUpdate => Observable.AsObservable<RewardWithManyConditions>((IObservable<RewardWithManyConditions>)_onRewardUpdate);
	...
	public void Initialization()
	{
		...
		IObservable<RewardWithManyConditions> observable = Observable.Merge<RewardWithManyConditions>(AllRewardContainer.Rewards.Select((RewardWithManyConditions _reward) => _reward.OnUpdate));
		_anyRewardUpdateStream = ObservableExtensions.Subscribe<RewardWithManyConditions>(observable, (Action<RewardWithManyConditions>)delegate(RewardWithManyConditions reward)
		{
