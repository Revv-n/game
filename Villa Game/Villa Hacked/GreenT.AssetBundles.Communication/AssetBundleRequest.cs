...
public abstract class AssetBundleRequest : BaseFileRequest<AssetBundleResponse>
{
	...
	public bool isRemovePreviewBundle => (UnityEngine.Object)(object)previewBundle != null;
	...
	protected void SetBundleInfoToResponse(string[] splittedManifest)
	{
		...
		try
		{
			Hash128 bundleHash = Hash128.Parse(text.Split(':', StringSplitOptions.None)[1].Trim());
	...
	protected IEnumerator DownloadBundle()
	{
		...
		UnityWebRequest UnityWebRequestFactory()
		{
			return UnityWebRequestAssetBundle.GetAssetBundle(uri, cachedAssetBundle, 0u);
		}
	}
	...
	protected void SetBundleToResponse(UnityWebRequest unityWebRequest)
	{
		...
		if ((UnityEngine.Object)(object)bundleFromRequest != null && !HasError)
		{
			base.Response.bundle = bundleFromRequest;
		}
		else if ((UnityEngine.Object)(object)bundleFromRequest == null)
		{
