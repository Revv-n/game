...
public class LocalLoading : AssetBundleOperation
{
	...
	{
		AssetBundle val = (bundle = LoadBundle(bundle_name, completion_callback));
		Debug.Log($"Bundle {bundle_name} in SA: {(UnityEngine.Object)(object)val != null}");
		return (UnityEngine.Object)(object)val != null;
	}
