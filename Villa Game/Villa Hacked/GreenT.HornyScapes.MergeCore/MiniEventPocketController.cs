...
public class MiniEventPocketController : MiniEventMergeController<MiniEventPocketController>
{
	...
	public override void Init()
	{
		...
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<GIData>(instance.OnItemAdd, (Action<GIData>)AtItemAdded), (ICollection<IDisposable>)_trackStream);
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<GIData>(instance.OnItemRemove, (Action<GIData>)AtItemRemoved), (ICollection<IDisposable>)_trackStream);
	}
