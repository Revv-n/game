...
public class MergePointsController
{
	...
	public void Init()
	{
		...
		ObservableExtensions.Subscribe<Unit>(Controller<GameItemController>.Instance.StartFieldCreat, (Action<Unit>)delegate
		{
			SubscribeToItemCreated();
		});
		ObservableExtensions.Subscribe<Unit>(Controller<GameItemController>.Instance.EndFieldCreat, (Action<Unit>)delegate
		{
