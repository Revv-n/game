...
public class GetConcreteCompletedDialogueAnswersObjective : GainObjective, IConversationObjective
{
	...
	public override void Track()
	{
		...
		_completedStream = ObservableExtensions.Subscribe<bool>(Observable.Where<bool>(_dialoguesTracker.ObserveDeliveredPlayerMessages(_conversationId), (Func<bool, bool>)((bool dialogueIsComplete) => dialogueIsComplete)), (Action<bool>)delegate
		{
			AddProgress();
		});
	}
