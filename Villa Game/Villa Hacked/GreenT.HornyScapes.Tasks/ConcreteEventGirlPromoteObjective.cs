...
public sealed class ConcreteEventGirlPromoteObjective : AnyGirlPromoteObjective
{
	...
	public override void Track()
	{
		...
		anyPromoteStream = ObservableExtensions.Subscribe<ICard>(Observable.Where<ICard>(cardsCollectionTracker.GetAnyPromoteStream(), (Func<ICard, bool>)((ICard value) => value.ContentType == contentType)), (Action<ICard>)delegate
		{
			AddProgress();
		});
	}
