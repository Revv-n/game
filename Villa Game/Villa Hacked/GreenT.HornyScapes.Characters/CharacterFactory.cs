...
public class CharacterFactory : IFactory<CharacterInfoMapper, CharacterInfo>, IFactory
{
	...
	{
		CharacterBonusParameters characterBonusParameters = new CharacterBonusParameters(mapper.id, mapper.bonus.ToString(), mapper.bonus, mapper.bonus_value, mapper.affect_all, mapper.spawner_id);
		return bonusFactory.Create(characterBonusParameters) as IBonus;
	}
