...
public class ChainBundleLotView : LotView
{
	...
	public void SetupAvailabilityState(bool isAvailable)
	{
		...
		DOTweenModuleUI.DOFade(_canvasGroup, 0f, 0.5f).OnComplete(delegate
		{
	...
	private void StartTrackPreviousBundle()
	{
		...
		_lotBoughtTrackStream = ObservableExtensions.Subscribe<LotBoughtSignal>(signalBus.GetStream<LotBoughtSignal>(), (Action<LotBoughtSignal>)delegate(LotBoughtSignal signal)
		{
