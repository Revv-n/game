...
public class BundleLotFeaturesView : LotFeaturesView
{
	...
	public override void Set(LotFeatures features)
	{
		...
		{
			_localizationDisposable = ObservableExtensions.Subscribe<string>((IObservable<string>)_localizationService.ObservableText(text2), (Action<string>)delegate(string text)
			{
