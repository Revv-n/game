...
public class CheatWindow : Window
{
	...
	{
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<Unit>(Observable.Where<Unit>(UnityUIComponentExtensions.OnClickAsObservable(switchRegionBtn), (Func<Unit, bool>)((Unit _) => _regionPriceResolver != null)), (Action<Unit>)delegate
		{
