...
public class MonetizationAnalytic : BaseAnalytic<Product>
{
	...
	public override void Track()
	{
		...
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<Transaction>(iapSystem.OnSucceeded, (Action<Transaction>)SendSucceededEvent), (ICollection<IDisposable>)onNewStream);
