...
public class QueueControllerInitializer : IInitializable, IDisposable
{
	...
	public void Initialize()
	{
		...
		_onGameActiveStream = ObservableExtensions.Subscribe<bool>(Observable.Where<bool>((IObservable<bool>)_gameStarter.IsGameActive, (Func<bool, bool>)((bool x) => x)), (Action<bool>)InitializeControllers);
	}
