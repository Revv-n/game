...
public class MonoMonetizationPopupInstaller : MonoInstaller<MonoMonetizationPopupInstaller>
{
	...
	{
		((ArgConditionCopyNonLazyBinder)((ScopeConcreteIdArgConditionCopyNonLazyBinder)((MonoInstallerBase)this).Container.BindInterfacesAndSelfTo<MonetizationPopupFactory<SteamPopup>>()).AsSingle()).WithArguments<Canvas, SteamPopup>(canvasParent, windowsSteamPopupPrefab);
	}
}
