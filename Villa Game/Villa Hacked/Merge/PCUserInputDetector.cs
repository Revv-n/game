...
public class PCUserInputDetector : UserInputDetector
{
	...
	{
		return Observable.AsObservable<UserInputDetector>((IObservable<UserInputDetector>)onEsc);
	}

	public virtual IObservable<UserInputDetector> OnSpace()
	{
		return Observable.AsObservable<UserInputDetector>((IObservable<UserInputDetector>)onSpace);
	}
	...
	{
		onEsc.OnNext((UserInputDetector)this);
	}

	protected void SpacePressed()
	{
		onSpace.OnNext((UserInputDetector)this);
	}
}
