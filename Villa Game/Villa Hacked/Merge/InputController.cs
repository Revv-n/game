...
public class InputController : Controller<InputController>, IMasterController, IDisposable
{
	...
	{
		_activityStream = ObservableExtensions.Subscribe<bool>(Observable.Select<bool, bool>(Observable.Merge<bool>((IObservable<bool>)_mergeScreenIndicator.IsVisible, new IObservable<bool>[1] { (IObservable<bool>)_eventMergeScreenIndicator.IsVisible }), (Func<bool, bool>)((bool _) => _eventMergeScreenIndicator.IsVisible.Value || _mergeScreenIndicator.IsVisible.Value)), (Action<bool>)SetInputActivity);
	}
	...
	{
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<UserInputDetector>(_inputDetector.OnPointerDown(), (Action<UserInputDetector>)delegate(UserInputDetector _input)
		{
		...
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<UserInputDetector>(_inputDetector.OnPointerUp(), (Action<UserInputDetector>)delegate(UserInputDetector _input)
		{
			Vector2 worldPosition = gameCamera.ScreenToWorldPoint(_input.PointerScreenPosition);
			_pointerListeners.ForEach(delegate(IPointerController x)
			{
		...
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<UserInputDetector>(_inputDetector.OnClick(), (Action<UserInputDetector>)delegate(UserInputDetector _input)
		{
			Vector2 worldPosition = gameCamera.ScreenToWorldPoint(_input.PointerScreenPosition);
		...
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<UserInputDetector>(_inputDetector.OnDragBegin(), (Action<UserInputDetector>)delegate(UserInputDetector _input)
		{
			Vector2 worldPosition = gameCamera.ScreenToWorldPoint(_input.PointerScreenPosition);
			Vector2 downPosition = gameCamera.ScreenToWorldPoint(_input.PointerDownScreenPosition);
			_dragListeners.ForEach(delegate(IDragController x)
		...
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<UserInputDetector>(_inputDetector.OnDragging(), (Action<UserInputDetector>)delegate(UserInputDetector _input)
		{
			Vector2 worldPosition = gameCamera.ScreenToWorldPoint(_input.PointerScreenPosition);
			_dragListeners.ForEach(delegate(IDragController x)
			{
		...
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<UserInputDetector>(_inputDetector.OnDragEnd(), (Action<UserInputDetector>)delegate(UserInputDetector _input)
		{
