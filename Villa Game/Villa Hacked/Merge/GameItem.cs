...
public class GameItem : MonoBehaviour, IHasCoordinates
{
	...
	public IObservable<GameItem> OnRemovingObservable => (IObservable<GameItem>)_onRemovingObservable;
	...
	public Tween DoCreate()
	{
		...
		sequence.Join(DOTweenModuleSprite.DOFade(IconRenderer, 1f, 0.24f));
