...
public class ArrowAnimationSystem : Animation
{
	...
	{
		seq.Append(DOTweenModuleUI.DOAnchorPos(toolTipTransform, endPosition, durationToEndPos).SetEase(moveToEndEasy)).Join(DOTweenModuleUI.DOFade(myCanvasGroup, 1f, durationToEndPos));
		return seq;
	}
