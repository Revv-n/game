...
public class GalleryState : ISavableState
{
	...
	protected int[] unlockedMediaIDs;
	...
	public int[] GainedMediaIDs => unlockedMediaIDs.Except(CurrentGaleryMediaIDs).ToArray();
