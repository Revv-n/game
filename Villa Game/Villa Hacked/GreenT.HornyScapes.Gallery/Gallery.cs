...
public class Gallery : IGallery, ICollectionSetter<Media>, ICollectionSetter<IMediaInfo>, IMediaInfoCollection
{
	...
	public IObservable<Media> OnMediaAdded => Observable.AsObservable<Media>((IObservable<Media>)mediaAdded);

	public IObservable<Media> OnMediaReplaced => Observable.AsObservable<Media>((IObservable<Media>)mediaReplaced);
