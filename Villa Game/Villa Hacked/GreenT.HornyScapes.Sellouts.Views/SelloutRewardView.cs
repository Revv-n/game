...
public class SelloutRewardView : MonoView<(int Id, SelloutRewardsInfo RewardInfo)>
{
	...
	public void SetTargetPoints(Sellout sellout, int startValue, int endValue)
	{
		...
		_pointsStream = ObservableExtensions.Subscribe<int>((IObservable<int>)_sellout.Points, (Action<int>)delegate(int points)
		{
			UpdatePoints(points);
	...
	private void UpdatePoints(int points)
	{
		...
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<string>((IObservable<string>)_localizationService.ObservableText("ui.sellout.points_needed"), (Action<string>)delegate(string text)
		{
