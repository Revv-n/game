...
public class BackgroundBundleLoader : ILoader<string, BannerBackgroundBundle>
{
	...
	{
		return Observable.Select<IAssetBundle, BannerBackgroundBundle>(_assetBundlesManager.DownloadAssetBundle(GetPath(bundleName)), (Func<IAssetBundle, BannerBackgroundBundle>)((IAssetBundle assetBundle) => assetBundle.LoadAllAssets<BannerBackgroundBundle>().FirstOrDefault()));
	}
