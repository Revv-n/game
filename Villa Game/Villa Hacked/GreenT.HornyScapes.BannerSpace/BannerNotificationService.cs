...
public class BannerNotificationService : IBannerNotificationService
{
	...
	public IObservable<CreateData> OnBannerLoaded => (IObservable<CreateData>)_bannerLoadedSubject;

	public IObservable<int> OnBannerReady => (IObservable<int>)_bannerReadySubject;

	public IObservable<int> OnBannerClose => (IObservable<int>)_bannerCloseSubject;
