...
public class RoomObjectsBuilder : IHouseBuilder, IDisposable
{
	...
	public IObservable<IRoomObject<BaseObjectConfig>> OnCreated => Observable.AsObservable<IRoomObject<BaseObjectConfig>>((IObservable<IRoomObject<BaseObjectConfig>>)onCreated);
