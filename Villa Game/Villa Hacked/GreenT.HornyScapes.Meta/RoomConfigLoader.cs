...
public class RoomConfigLoader : IBundlesLoader<IEnumerable<int>, IEnumerable<RoomConfig>>, ILoader<IEnumerable<int>, IEnumerable<RoomConfig>>
{
	...
	{
		return Observable.Buffer<RoomConfig>(Observable.SelectMany<int, RoomConfig>(Observable.ToObservable<int>(ids), (Func<int, IObservable<RoomConfig>>)roomBundleLoader.Load), ids.Count());
	}
