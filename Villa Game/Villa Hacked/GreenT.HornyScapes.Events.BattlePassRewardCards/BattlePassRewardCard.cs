...
public class BattlePassRewardCard : MonoView<RewardWithManyConditions>
{
	...
	public override void Set(RewardWithManyConditions reward)
	{
		...
		stateStream = ObservableExtensions.Subscribe<EntityStatus>((IObservable<EntityStatus>)base.Source.State, (Action<EntityStatus>)UpdateState);
	...
	private void SetCompleteState()
	{
		...
		completeObject.SetActive(value: false);
		claimButtonSubscribe = ObservableExtensions.Subscribe<Unit>(UnityUIComponentExtensions.OnClickAsObservable(claimButton), (Action<Unit>)delegate
		{
