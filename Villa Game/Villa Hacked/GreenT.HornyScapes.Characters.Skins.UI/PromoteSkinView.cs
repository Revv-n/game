...
public class PromoteSkinView : NodeMonoView<PromoteSkinView.Settings>, IPointerClickHandler, IEventSystemHandler
{
	...
	public IObservable<Skin> OnSelect => Observable.AsObservable<Skin>((IObservable<Skin>)onSelect);
	...
	public override void Set(Settings source)
	{
		...
		characterUpdateStream = ObservableExtensions.Subscribe<CharacterSettings>(source.CharacterSettings.OnUpdate, (Action<CharacterSettings>)UpdateView);
