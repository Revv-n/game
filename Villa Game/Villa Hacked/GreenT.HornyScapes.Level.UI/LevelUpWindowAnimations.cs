...
public class LevelUpWindowAnimations : MonoBehaviour
{
	...
	{
		ResetAnimation();
		DOTweenModuleUI.DOColor(popUp, popUpColor, animationDuration);
	...
	private void ShowMain()
	{
		...
		DOTweenModuleUI.DOFade(main, 1f, animationDuration);
	...
	private void InitGirl(Image girl, float slide)
	{
		...
		DOTweenModuleUI.DOFade(girl, 1f, animationDuration);
	...
	public Sequence Hide()
	{
		...
		sequence.Join(DOTweenModuleUI.DOFade(allGraphic, 0f, hideDuration));
		return sequence;
	}
