...
public class OfferPreview : MonoView<OfferSettings>
{
	...
	private void SetTitle(OfferSettings offer)
	{
		if (titleTextFields != null)
		{
			...
			localizationStream = ObservableExtensions.Subscribe<string>((IObservable<string>)_localizationService.ObservableText(offer.Bundles[0].NameKey), (Action<string>)SetForEachTextField);
		}
