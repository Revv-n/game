...
public class ResourcesWindow : Window
{
	...
	private ReactiveCollection<CurrencyType> visibleCurrencyTypes;
	...
	[Inject]
	public void Init(ReactiveCollection<CurrencyType> visibleCurrencyTypes, IWindowsManager windowsManager, ContentSelectorGroup contentSelectorGroup)
	{
	...
	private void TrackCurrencyChanges(ReactiveCollection<CurrencyType> visibleCurrencyTypes)
	{
		currencyStream.Clear();
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<CurrencyType>(Observable.Select<CollectionAddEvent<CurrencyType>, CurrencyType>(Observable.Where<CollectionAddEvent<CurrencyType>>(visibleCurrencyTypes.ObserveAdd(), (Func<CollectionAddEvent<CurrencyType>, bool>)((CollectionAddEvent<CurrencyType> _) => IsOpened)), (Func<CollectionAddEvent<CurrencyType>, CurrencyType>)((CollectionAddEvent<CurrencyType> _event) => _event.Value)), (Action<CurrencyType>)ShowCurrency), (ICollection<IDisposable>)currencyStream);
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<CurrencyType>(Observable.Select<CollectionRemoveEvent<CurrencyType>, CurrencyType>(visibleCurrencyTypes.ObserveRemove(), (Func<CollectionRemoveEvent<CurrencyType>, CurrencyType>)((CollectionRemoveEvent<CurrencyType> _event) => _event.Value)), (Action<CurrencyType>)HideCurrency), (ICollection<IDisposable>)currencyStream);
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<IEnumerable<CurrencyType>>(Observable.Select<CollectionAddERangEvent<CurrencyType>, IEnumerable<CurrencyType>>(Observable.Where<CollectionAddERangEvent<CurrencyType>>(visibleCurrencyTypes.ObserveSet(), (Func<CollectionAddERangEvent<CurrencyType>, bool>)((CollectionAddERangEvent<CurrencyType> _) => IsOpened)), (Func<CollectionAddERangEvent<CurrencyType>, IEnumerable<CurrencyType>>)((CollectionAddERangEvent<CurrencyType> _event) => _event.Items)), (Action<IEnumerable<CurrencyType>>)SetVisibleCurrencies), (ICollection<IDisposable>)currencyStream);
	}
