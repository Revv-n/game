...
public class RecipeBookUIController : Controller<RecipeBookUIController>, IDisposable
{
	...
	{
		_eventChangeStream = ObservableExtensions.Subscribe<CalendarModel>(Observable.Where<CalendarModel>(_calendarQueue.OnCalendarActiveNotNull(), (Func<CalendarModel, bool>)((CalendarModel calendarModel) => calendarModel.EventType == EventStructureType.Event)), (Action<CalendarModel>)SetRecipeBook);
	}
