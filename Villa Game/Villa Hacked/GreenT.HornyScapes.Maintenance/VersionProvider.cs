...
public class VersionProvider : IInitializable, IDisposable
{
	...
	{
		_subscription = ObservableExtensions.Subscribe<Response<ConfigurationInfo>>(_getConfigsVersionRequest.Get(), (Action<Response<ConfigurationInfo>>)delegate(Response<ConfigurationInfo> response)
		{
