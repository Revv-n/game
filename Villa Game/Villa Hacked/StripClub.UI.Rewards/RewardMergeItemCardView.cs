...
public class RewardMergeItemCardView : MonoBehaviour
{
	...
	public void Set(MergeItemLinkedContent content)
	{
		...
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<string>((IObservable<string>)_localizationService.ObservableText(key2), (Action<string>)delegate(string text)
		{
