...
public class AddResourcesClip : Clip
{
	...
	public override void Play()
	{
		...
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<long>(Observable.TakeUntilDisable<long>(Observable.Take<long>(Observable.Timer(TimeSpan.FromSeconds(flyResourcesDelay)), 1), (Component)this), (Action<long>)delegate
		{
