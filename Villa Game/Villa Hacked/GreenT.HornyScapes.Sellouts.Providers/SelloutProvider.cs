...
public class SelloutProvider
{
	...
	public IReadOnlyReactiveProperty<(CalendarModel calendar, Sellout sellout)> CurrentCalendarProperty => (IReadOnlyReactiveProperty<(CalendarModel calendar, Sellout sellout)>)(object)_currentCalendarProperty;
