...
public class LootboxOpener : ILootboxOpener, IDisposable
{
	...
	public IObservable<Lootbox> OnOpen => (IObservable<Lootbox>)onOpen;
	...
	{
		disposables.Clear();
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<Lootbox>(Observable.ContinueWith<Lootbox, Lootbox>(Observable.Take<Lootbox>(Observable.Where<Lootbox>(rewardsWindow.OnOpenWithLootbox, (Func<Lootbox, bool>)((Lootbox _lootbox) => lootbox == _lootbox)), 1), rewardsWindow.OnCloseWithLootbox), (Action<Lootbox>)onOpen.OnNext), (ICollection<IDisposable>)disposables);
