...
public class EventItemsRewardCard : EventRewardCard, IDisposable
{
	...
	private void HandleCurrencyContent(CurrencyLinkedContent currencyLinkedContent)
	{
		...
		_iconChangeStream = ObservableExtensions.Subscribe<Sprite>(ObserveExtensions.ObserveEveryValueChanged<CurrencySettings, Sprite>(currencySettings, (Func<CurrencySettings, Sprite>)((CurrencySettings actualSettings) => actualSettings.AlternativeSprite), (FrameCountType)0, false), (Action<Sprite>)delegate(Sprite sprite)
		{
