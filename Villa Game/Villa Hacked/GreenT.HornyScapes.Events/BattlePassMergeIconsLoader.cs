...
public class BattlePassMergeIconsLoader : IBundlesLoader<string, IEnumerable<Sprite>>, ILoader<string, IEnumerable<Sprite>>
{
	...
	public BattlePassMergeIconsLoader(IAssetBundlesLoader assetBundlesLoader, IProjectSettings projectSettings, BundleType bundleType, string subFolderName)
	{
