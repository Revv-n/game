...
public class ShowButtonByLockerData : ShowButtonByLocker
{
	...
	{
		lockerModel = lockerFactory.Create(lockerData.UnlockType, lockerData.UnlockValue, LockerSourceType.ShowButtonByLocker);
	}

	protected override IObservable<bool> GetCondition()
	{
		return (IObservable<bool>)lockerModel.IsOpen;
	}
}
