...
public class ConversationHeader : MonoView<Conversation>
{
	...
	public override void Set(Conversation conversation)
	{
		...
		_titleDisposable = ObservableExtensions.Subscribe<string>((IObservable<string>)_localizationService.ObservableText(currentConversation.NameKey), (Action<string>)delegate(string localizedName)
		{
