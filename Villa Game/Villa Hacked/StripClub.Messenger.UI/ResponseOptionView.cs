...
public class ResponseOptionView : Button, IView<ResponseOption>, IView
{
	...
	public void Set(ResponseOption option)
	{
		...
		_localizationDisposable = ObservableExtensions.Subscribe<string>((IObservable<string>)_localizationService.ObservableText(option.LocalizationKey), (Action<string>)delegate(string text)
		{
