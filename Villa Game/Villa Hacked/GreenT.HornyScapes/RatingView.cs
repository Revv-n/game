...
public class RatingView : MonoView<RatingData>
{
	...
	public void InnerInit()
	{
		...
		_playersViewUpdateDisposable?.Dispose();
		_playersViewUpdateDisposable = ObservableExtensions.Subscribe<RatingPlayerView>(_scrollPool.OnOpponentViewPositionUpdate, (Action<RatingPlayerView>)delegate(RatingPlayerView view)
		{
			if (RatingController != null)
			{
