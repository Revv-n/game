...
public sealed class EventEnergyModeTempService : IInitializable, IDisposable
{
	...
	{
		_eventsStateStream = ObservableExtensions.Subscribe<CalendarModel>(_calendarQueue.OnCalendarActive(EventStructureType.Event), (Action<CalendarModel>)delegate(CalendarModel value)
		{
