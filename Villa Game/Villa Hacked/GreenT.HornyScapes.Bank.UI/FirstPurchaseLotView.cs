...
public class FirstPurchaseLotView : LotView
{
	...
	public override void Set(Lot lot)
	{
		...
		bundleLockerStream = ObservableExtensions.Subscribe<bool>((IObservable<bool>)lot.Locker.IsOpen, (Action<bool>)SetupButton);
	}
	...
	public override void Purchase()
	{
		if (base.Source.Locker.IsOpen.Value)
		{
			...
			onBuyStream = ObservableExtensions.Subscribe<bool>(onResult, (Action<bool>)OnPurchaseEnded);
