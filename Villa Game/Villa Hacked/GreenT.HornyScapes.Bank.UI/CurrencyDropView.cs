...
public class CurrencyDropView : MonoView
{
	...
	public void Set(CurrencyType currency, int? quantity, CompositeIdentificator compositeIdentificator)
	{
		...
		_iconChangeStream = ObservableExtensions.Subscribe<Sprite>(ObserveExtensions.ObserveEveryValueChanged<CurrencySettings, Sprite>(gameSettings.CurrencySettings[currency, compositeIdentificator], (Func<CurrencySettings, Sprite>)((CurrencySettings actualSettings) => actualSettings.AlternativeSprite), (FrameCountType)0, false), (Action<Sprite>)delegate(Sprite currentValue)
		{
