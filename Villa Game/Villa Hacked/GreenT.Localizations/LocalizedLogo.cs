...
public class LocalizedLogo : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		_localizationDownloadStream = ObservableExtensions.Subscribe<string>(_localizationState.OnLanguageChange, (Action<string>)ChangeLogoLanguage, (Action<Exception>)delegate(Exception exception)
		{
