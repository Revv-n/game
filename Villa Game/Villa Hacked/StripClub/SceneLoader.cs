...
public static class SceneLoader
{
	...
	{
		return Observable.FromCoroutine((Func<IEnumerator>)(() => LoadScenes(sceneParameters, loadMode)), false);
	}
	...
	{
		return Observable.FromCoroutine((Func<IEnumerator>)(() => LoadScene(sceneInfo, loadMode)), returnEveryYield);
	}
}
