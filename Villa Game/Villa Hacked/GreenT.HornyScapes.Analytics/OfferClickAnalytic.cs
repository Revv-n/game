...
public class OfferClickAnalytic : OfferShowAnalyticBase
{
	...
	{
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<OfferSettings>(offer.OnClicked, (Action<OfferSettings>)SendEventByPass), (ICollection<IDisposable>)onNewStream);
	}
